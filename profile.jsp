                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user form-container" id="f">
                                        <div class="form-control form-control-user">
                                            <span>아이디:&nbsp;${SS_USER_ID}</span>
                                        </div>

                                        <br>
                                        <div class="form-control form-control-user">
                                            <span>이메일 주소:&nbsp;${SS_DECRYPTED_EMAIL}</span>
                                        </div>

                                        <br>
                                        <%--                                        <div class="form-control form-control-user">--%>
                                        <%--                                            <span>비밀번호:&nbsp;${SS_PASSWORD}</span>--%>
                                        <%--                                        </div>--%>
                                        ...
                                        <hr>
<%--                                        <div class="text-center">--%>
<%--                                            <a id="bthuserid" type="button" class="btn btn-primary btn-user btn-block" style="cursor: pointer">아이디 변경</a>--%>
<%--                                        </div>--%>
<%--                                        <br>--%>
                                        <div class="text-center">
                                        ...
                                        <hr>
                                        <div class="text-center">
                                            <a id="bthIndex" type="button" class="btn btn-primary btn-user btn-block" style="cursor: pointer">돌아가기</a>
                                        </div>
